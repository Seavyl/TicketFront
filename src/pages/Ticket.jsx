...
export default function Ticket() {
  ...
  // récupère la liste au premier rendu
  useEffect(() => {
  ...
  // 3) crée un tableau de PAGE_SIZE éléments,
  //    mélange "tickets" et "placeholder" si besoin
  const items = [
    ...displayed,
  ...
  // 4) gestion du changement de quantité
  const handleQuantityChange = (id, qty) =>
    ...
    return (
        <div className="flex flex-col bg-bg-color" style={{
...
>
          ...
          ">
                ...
                ">
                            ...
                            : (
                                <div key={item.id} className="w-full h-auto lg:h-full">
                                    <TicketCard ticket={item} onQuantityChange={handleQuantityChange}/>
                                </div>
                            ))}
                </div>
            </div>
